    ...
    <Box p={20} bg={"gray.100"}>
      <Box>
        ...
        >
          ...
          <BreadcrumbItem>
            <BreadcrumbLink href={`/Myvet/#/PreCategory/${category}`}>Category</BreadcrumbLink>
          </BreadcrumbItem>
      ...
      >
        ...
        >
          ...
          <Heading
            ...
            zIndex={1}
          >
            <Link to={`/Categories/Shoe`} className="hover:underline">
              Shoes
            </Link>
          </Heading>
          <Box
            bgImage={category == "Women" ? "url('src/Assets/Shoes1.jpg')" : "url('src/Assets/Shoes.jpg')" }
            bgSize="fill"
            bgPosition="bottom"
            bgRepeat="no-repeat"
            bgColor={'gray.200'}
        ...
        >
          ...
          <Box
            bgImage={category== "Women" ? "url('src/Assets/Hoodie.jpg')" : "url('src/Assets/Hoodie1.jpg')"}
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
            borderRadius="md"
